...
function EducatorProfile() {
  ...
  const edCourses = [
    {
      id: 1,
      aboutcourse: "This is will help you to achieve your goal within time limit",
      active: false,
      endsDate: "2026",
                  ...
                  edCourses.map((element) => (
                    <NavLink key={element.id} className=" ">
                      <div className="max-w-sm relative bg-white border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <i className='bg-[red] rounded-xl right-0  px-1 absolute font-bold text-white '>{element.active ? "New" : "has ended"} </i>
                        <a href="#">
                          <img className="rounded-t-lg" src={element.imgsource} alt="" />
                        </a>
                        <div className="p-5">
                          <a href="#">
                            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{element.batchTitle}</h5>
                          </a>
